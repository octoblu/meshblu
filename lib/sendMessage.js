...
function createMessageSender(socketEmitter, mqttEmitter){
  var broadcastMessage = function(data, topic, fromUuid, fromDevice){
  ...
  var sendMessage = function(device, data, topic, fromUuid, fromDevice){
  ...
  return function(fromDevice, data, topic){
    ...
    console.log("sendMessage.js from", fromUuid, data);
    ...
    devices.forEach( function(device) {
      sendMessage(device, data, topic, fromUuid, fromDevice);
    });
  };
}
