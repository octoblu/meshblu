...
var coapServer = require('./lib/coapServer'),
    coapConfig = require('./config').coap;

coapServer.setup(app);

// Integrate restful routes
var restfulRoutes = require('./lib/restfulRoutes');

// Now, setup both servers in one step
restfulRoutes.setup(server);

if(config.tls){
  restfulRoutes.server(https_server);
}
